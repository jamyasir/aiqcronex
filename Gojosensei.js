...
`
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    {
                        urlButton: {
                            displayText: '🖤𝗔𝗶𝗾𝗰𝗿𝗼𝗻𝗲𝘅 FB🖤',
                            url: `https://web.facebook.com/people/Jam-Yasir/100061694101443/`
                        }
                    }]
                    let txt = `「 Aiqcronex  HERE🎉✾ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬✾➣ 」\n\n${text}`
            ...
            case 'bc': case 'broadcast': case 'bcall': {
                ...
                for (let yoi of anu) {
                    ...
                    let txt = `「 𝗔𝗶𝗾𝗰𝗿𝗼𝗻𝗲𝘅 HERE 🎉✾ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬✾➣」\n\n${text}`
...
◈ Url : ${anu.url}`,
            ...
            case 'stalker': case 'stalk': {
                ...
                if (type.toLowerCase() == 'ff') {
                    ...
                    if (!id) return reply(`No Query username, Example : ${prefix + command} ig jam_yasir03`)
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            case 'bug': case 'report': {
                ...
                GojoMdNx.sendMessage(`918129624395@s.whatsapp.net`, {
...
└┬──────────────┈ ⳹
   ...
   └───────────────┈ ⳹`,
                            hydratedButtons: [{
                                ...
                                urlButton: {
                                    displayText: '🦋⃝❉⃟࿔ꦿ𝗔𝗶𝗾𝗰𝗿𝗼𝗻𝗲𝘅 𝚂𝙲𝚁𝙸𝙿𝚃🌹⃝✥⃟☺️᭄ꦿ',
                                    url: `${sc}`
                                }
                            }, {
                                quickReplyButton: {
...
♪♫•*¨*•.¸¸❤¸¸.•*¨*•♫♪
   └───────────────┈ ⳹`,
                    hydratedButtons: [{
                        ...
                        urlButton: {
                            displayText: '🦋⃝❉⃟࿔ꦿ𝗔𝗶𝗾𝗰𝗿𝗼𝗻𝗲𝘅 Script✾ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬✾➣',
                            url: `${sc}`
                        }
                    }, {
                        quickReplyButton: {
    ...
    break
            case 'sc': case 'script': {
        reply(`GitHub : https://github.com/jamyasir/aiqcronex\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
    }
    break
case 'allmenu': {
        anu = `
...
case 'thanksto': case 'tqto': case 'tqtt':
    ...
    await GojoMdNx.send5ButImg(from, `` + '' + ' ', `
Thanks to Me ( Aiqcronex)
Aiqcronex (For helping me to deploy qr in replit and answered my every doubts regard this project)
MR_UFO(YASIR) ( 100% Credits goes to him ,in this script)
And Again Me (King Aiqcronex 🎉) 🐦 Who Helped Assemble This Smexy Script !!!`, unicorn, [{ "urlButton": { "displayText": "YouTube📍", "url": `${myweb}` } }, { "urlButton": { "displayText": "Script🔖", "url": `${sc}` } }, { "quickReplyButton": { "displayText": "🍜Donate🍜", "id": 'donate' } }, { "quickReplyButton": { "displayText": "👤Owner👤", "id": 'owner' } }])
    break;
            default:
    if (budy.startsWith('=>')) {
